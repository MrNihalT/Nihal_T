                    ...
                    value: function () {
                        ...
                        r.paused ||
                            ...
                            (e =
                                -(
                                    Math.min(
                                        Math.max(-r.mouseY, -r.size),
                                        r.size
                                    ) / r.radius
                                ) * r.maxSpeed),
                            (t =
                                (Math.min(
                                    Math.max(-r.mouseX, -r.size),
                                    r.size
                                ) /
                                    r.radius) *
                                r.maxSpeed),
                            (Math.abs(e) <= 0.01 && Math.abs(t) <= 0.01) ||
                                ...
                                r.items.forEach(function (e) {
                                    ...
                                    (o = (
                                        ...
                                        (n = e.el),
                                        (i = (e.x - n.offsetWidth / 2).toFixed(
                                            2
                                        )),
                                        (t = (e.y - n.offsetHeight / 2).toFixed(
                                            2
                                        )),
                                        (e = "translate3d("
                                            .concat(i, "px, ")
